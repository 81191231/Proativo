...
<div class="right_col" role="main" style="min-height: 3162px;">
  <div>
    <div class="page-title">
      ...
      @if(!empty($msg))
        @if($msg=="sucesso")
        <div id="modal" class="alert alert-success" role="alert">Campo deletado com sucesso!<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>
        @else
            ...
            <div class="col-sm-12">
              ...
              <tbody>
                ...
                <tr class="odd" role="row">
                  ...
                  <td><a href="{{URL::to('Tipo_Documento/'.$tipo_documento->id.'/Deletar')}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Deletar">Deletar</a>
                  </td> 
                </tr>
                <!--Fim linha da Tabela-->
                @endforeach
