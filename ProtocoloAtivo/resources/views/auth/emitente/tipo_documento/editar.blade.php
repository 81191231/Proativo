          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['url'=>'Tipo_Documento/'.$tipo_documento->id.'/Update'],['name'=>'Tipo_Documento']) !!}  
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control col-md-7 col-xs-12" name="nome" value="{{$tipo_documento->nome}}"> 
                  </div>
                </div>
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea name="descricao" value="{{$tipo_documento->descricao}}" class="form-control col-md-7 col-xs-12">
                    </textarea>
                  </div>
                </div>
