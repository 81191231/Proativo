...
<head>
  ...
  <!--CSS-->
  <link href="{{URL::asset('lib/css.css')}}" rel="stylesheet">
 <script type="text/javascript">
    var xmlhttp = new XMLHttpRequest();
    function showPNovo(){
     xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                return document.getElementById("sectionUse").innerHTML = this.responseText;
            }
        };
    xmlhttp.open("GET", "Protocolo/Novo", true);
    xmlhttp.send();
    }
    //
    function showPListar(){
      
    xmlhttp.open("GET", "Protocolo/Listar", true);
    xmlhttp.send();
    }
  </script>
</head>
        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile">
            <div class="profile_pic">
              <img src="{{URL::asset('img/user.png')}}" alt="Usuario" class="img-circle profile_img">
            </div>
